...
### Download [the latest stable release](https://github.com/WaffleProj/WaffleNG/releases) or [the latest nightly build](https://github.com/WaffleProj/WaffleNG/archive/master.zip).
