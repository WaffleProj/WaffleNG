    ...
    )
{
    ...
    LPWOW64DISABLEWOW64FSREDIRECTION lpWow64DisableWow64FsRedirection = (LPWOW64DISABLEWOW64FSREDIRECTION) WaffleGetProcAddress(hKernel32, "Wow64DisableWow64FsRedirection");
    ...
    )
{
    ...
    LPWOW64REVERTWOW64FSREDIRECTION lpWow64RevertWow64FsRedirection = (LPWOW64REVERTWOW64FSREDIRECTION) WaffleGetProcAddress(hKernel32, "Wow64RevertWow64FsRedirection");
